...
public class BSBottomNavigation extends RelativeLayout {
     ...
     * Constructors
     */
    public BSBottomNavigation(Context context) {
        this(context, null);
    }

    public BSBottomNavigation(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSBottomNavigation(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BSBottomNavigation);
            spaceItemIconSize = typedArray.getDimensionPixelSize(R.styleable.BSBottomNavigation_space_item_icon_size, resources.getDimensionPixelSize(R.dimen.space_item_icon_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(R.styleable.BSBottomNavigation_space_item_icon_only_size, resources.getDimensionPixelSize(R.dimen.space_item_icon_only_size));
            spaceItemTextSize = typedArray.getDimensionPixelSize(R.styleable.BSBottomNavigation_space_item_text_size, resources.getDimensionPixelSize(R.dimen.space_item_text_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(R.styleable.BSBottomNavigation_space_item_icon_only_size, resources.getDimensionPixelSize(R.dimen.space_item_icon_only_size));
            spaceBackgroundColor = typedArray.getColor(R.styleable.BSBottomNavigation_space_background_color, resources.getColor(R.color.space_default_color));
            centreButtonColor = typedArray.getColor(R.styleable.BSBottomNavigation_centre_button_color, resources.getColor(R.color.centre_button_color));
            activeSpaceItemColor = typedArray.getColor(R.styleable.BSBottomNavigation_active_item_color, resources.getColor(R.color.space_white));
            inActiveSpaceItemColor = typedArray.getColor(R.styleable.BSBottomNavigation_inactive_item_color, resources.getColor(R.color.default_inactive_item_color));
            centreButtonIcon = typedArray.getResourceId(R.styleable.BSBottomNavigation_centre_button_icon, R.drawable.near_me);
            isCentrePartLinear = typedArray.getBoolean(R.styleable.BSBottomNavigation_centre_part_linear, false);
            activeCentreButtonIconColor = typedArray.getColor(R.styleable.BSBottomNavigation_active_centre_button_icon_color, resources.getColor(R.color.space_white));
            inActiveCentreButtonIconColor = typedArray.getColor(R.styleable.BSBottomNavigation_inactive_centre_button_icon_color, resources.getColor(R.color.default_inactive_item_color));
            activeCentreButtonBackgroundColor = typedArray.getColor(R.styleable.BSBottomNavigation_active_centre_button_background_color, resources.getColor(R.color.centre_button_color));
        ...
        centreButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (navigationClickListner != null)
                    navigationClickListner.onCentreButtonClick();
    ...
    private void updateSpaceItems(final int selectedIndex) {
        ...
        if (currentSelectedItem == selectedIndex) {
            if (navigationClickListner != null && selectedIndex >= 0)
                navigationClickListner.onItemClick(selectedIndex, spaceItems.get(selectedIndex).getItemName());
    ...
    private void postRequestLayout() {
        BSBottomNavigation.this.getHandler().post(new Runnable() {
            @Override
            public void run() {
                BSBottomNavigation.this.requestLayout();
            }
        });
    }
     ...
     */
    public void addButton(String title, int drawable) {
        spaceItems.add(new SpaceItem(title, drawable));
    }
     ...
     *
     * @param navigationClickListner space click listener
     */
    public void setButtonClickListener(NavigationClickListner navigationClickListner) {
     ...
     */
    public void setSelectedItem(int indexToChange) {
